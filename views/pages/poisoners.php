...
?>
    <div class="container-lg card-body">
        <div class="main-products2">
            <h2 id="discount" class="product-main text-secondary">Протруйники</h2>
        </div>
        <div class="card-container d-flex justify-content-center" id="products-container">
            <div class="card">
                <a href="/alberto" class="text-dark text-decoration-none">
                    <div class="card-content">
                        <img class="image-main" src="<?= IMAGES_URI ?>/alberto.jpg" alt="">
                        <h6 class="text-center mt-3">АЛЬБЕРТО</h6>
                        <p class="text-card">
                            <span>Тіaметоксам, 350 г/л</span>
                        </p>
                        <p class="text-center text-danger price-card">2930 грн / 5 л</p>
                    </div>
                </a>
            </div>
            <div class="card">
                <a href="/lainer" class="text-dark text-decoration-none">
                    <div class="card-content">
                        <img class="image-main" src="<?= IMAGES_URI ?>/lainer.jpg" alt="">
                        <h6 class="text-center mt-3">ЛАЙНЕР</h6>
                        <p class="text-card">
                            <span>Імідаклоприд, 600 г/л</span>
                        </p>
                        <p class="text-center text-warning price-card">Немає в наявності</p>
                    </div>
                </a>
            </div>
            <div class="card">
