...
?>
    <div class="container-lg card-body">
        <div class="main-products2">
            <h2 id="discount" class="product-main text-secondary">Прилипачі</h2>
        </div>
        <div class="card-container d-flex justify-content-center" id="products-container">
            <div class="card">
                <a href="/kait" class="text-dark text-decoration-none">
                    <div class="card-content">
                        <img class="image-main" src="<?= IMAGES_URI ?>/kait.jpg" alt="">
                        <h6 class="text-center mt-3">КАЙТ</h6>
                        <p class="text-card">
                            <span>Етоксилат нонилфенол</span>
                        </p>
                        <p class="text-center text-danger price-card">1050 грн / 5 л</p>
                    </div>
                </a>
            </div>
        </div>
