...
?>
    <div class="container-lg card-body">
        <div class="main-products2">
            <h2 id="discount" class="product-main text-secondary">Насіння кукурудзи</h2>
        </div>
        <div class="card-container d-flex justify-content-center" id="products-container">
            ...
            <div class="card">
                <a href="/hotin" class="text-dark text-decoration-none">
                    <div class="card-content">
                        <img class="image-main" src="<?= IMAGES_URI ?>/hotin.jpg" alt="">
                        <h6 class="text-center mt-3">ДБ Хотин</h6>
                        <p class="text-center text-danger price-card">1200 грн</p>
                    </div>
                </a>
            </div>
            <div class="card">
                <a href="/creative" class="text-dark text-decoration-none">
                    <div class="card-content">
                        <img class="image-main" src="<?= IMAGES_URI ?>/сreative.png" alt="">
                        <h6 class="text-center mt-3">Насіння кукурудзи ЕС КРЕАТИВ ( Lidea ) ФАО: 300 </h6>
...
<!--                    <div class="card-content">-->
<!--                        <img class="image-main" src="--><?php //= IMAGES_URI ?><!--" alt="">-->
